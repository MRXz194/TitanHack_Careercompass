...
Source-of-truth docs: `docs/API_CONTRACT.md`, `docs/ARCHITECTURE.md`, `docs/AI_DESIGN.md`, `docs/TASKS.md`, `docs/TEAM_RULES.md`, `docs/HANDOFF.md`, `docs/EVALUATION.md`, `docs/SECURITY_PRIVACY.md`.
