...
| Agent graph/tool/policy contract | ADR + `AGENTIC_RUNTIME.md` + StateGraph topology + Pydantic tools | M4 | M1/M3/M5/M6 | spike gate, deterministic fallback, allowlist/stage matrix + negative fixtures pass |
