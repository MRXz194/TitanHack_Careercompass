...
Runtime P0 dùng LangGraph `StateGraph` tối giản theo `ADR_AGENT_ORCHESTRATION.md`; đây chỉ là orchestration `/api/chat`. Session, policy, typed tools và recommendation vẫn thuộc code/domain hiện có.
