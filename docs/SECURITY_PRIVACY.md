...
- [x] Latest product-code automated dependency/endpoint smoke pass — `2fc677e`, CI `29660149913`: 388 backend + 81 frontend, compile/typecheck/build/runtime workflow/route invariant PASS; dependency production audit 0 vulnerability. Render/Vercel public smoke vẫn `NOT_RUN/BLOCKED` và không bị checkbox này che khuất. Xem `docs/next/RELEASE_SCORECARD.md`.
