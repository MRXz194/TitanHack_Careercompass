...
- [ ] Current-commit dependency và endpoint smoke pass — baseline `9a62969` từng pass; persona hardening hiện có 79/79 FE tests + typecheck/build local, còn backend current-branch CI và Render/Vercel smoke `NOT_RUN/BLOCKED`. Xem `docs/next/RELEASE_SCORECARD.md`.
