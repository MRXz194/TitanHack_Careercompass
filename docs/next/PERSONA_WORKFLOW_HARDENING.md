...
| PH-14 | Sev-1 verification | Backend host/Python không có trên máy audit | Không thể gọi local backend/pytest | Đã thay bằng CI Ubuntu 381 tests; local limitation còn nhưng gate đã pass |
...
- Frontend unit/persona/race/privacy/discoverability tests: **79/79 PASS local**.
...
- Backend compile + **334 unit/contract + 40 integration + 7 E2E + route invariant: PASS CI Ubuntu** ([run 29654386126](https://github.com/MRXz194/TitanHack_Careercompass/actions/runs/29654386126)); Python vẫn không có local.
